  ...
  return (
    <section id="maison" className="mx-auto max-w-4xl text-center px-6 pt-24 md:pt-36 pb-14 md:pb-24 scroll-mt-16 md:scroll-mt-20">
      <div className="reveal-on-scroll">
        ...
        <p className="mt-7 text-[#635A52] text-base md:text-lg leading-[1.8] max-w-xl mx-auto font-light">
          Cada peça da Célli Maison nasce para tornar o seu cotidiano um ritual.
        </p>
        <div className="w-px h-16 bg-[#9B7C55] mx-auto mt-12 transition-transform duration-700 origin-top hover:scale-y-125" />
      </div>
    </section>
  );
}
